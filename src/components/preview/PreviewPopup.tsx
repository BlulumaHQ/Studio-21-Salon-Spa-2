      ...
      >
        ...
        {version === "a" ? (
          <div style={{ marginBottom: "16px" }}>
            <a
              href="STRIPE_499"
              style={{ display: "block", width: "100%", textAlign: "center", padding: "0 24px", height: "64px", lineHeight: "64px", backgroundColor: "hsl(0,0%,12%)", color: "#fff", fontWeight: 700, fontSize: "18px", textTransform: "uppercase", letterSpacing: "0.06em", borderRadius: "2px", textDecoration: "none", boxSizing: "border-box" }}
            >
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "6px" }}>
              ...
              <div style={{ position: "relative" }} className="group">
                <span style={{ cursor: "help", color: "#aaa", fontSize: "11px", border: "1px solid #ccc", borderRadius: "50%", width: "16px", height: "16px", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>?</span>
